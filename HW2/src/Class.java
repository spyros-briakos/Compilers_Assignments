...
public class Class {
    ...
    public void Insert_Method(Method method_, Symbol_Table symbol_table) throws Exception {
        ...
        if(this.extend != null && this.Methods.size() == 0) {
            temp = symbol_table.Classes.get(this.extend);
    ...
    // maybe false, check it later
    // public void AddOffset(Class temp,String type,Boolean Meth_Var) {
    //     // Meth_Var: True -> Method
    //     if(Meth_Var) {
    //         .Method_Offset = temp.Method_Offset + 8;
    //         this.Method_Offset = this.Method_Offset + 8;
    //     }
    //     // Meth_Var: False -> Variable
    //     else {
    //         if(type == "int[]") {
    //             temp.Variable_Offset = temp.Variable_Offset + 8;
    //         }
    //         else if(type == "int") {
    //             temp.Variable_Offset = temp.Variable_Offset + 4;
    //         }
    //         else {
    //             temp.Variable_Offset = temp.Variable_Offset + 1;
    //         }
    //     }
    // }
}

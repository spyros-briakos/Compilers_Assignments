    ...
    public static void main (String [] args) {
        ...
        for(String filename : args) {
            try {
                ...
                BufferedWriter llvm_writer = new BufferedWriter(new FileWriter(filename.replace(".java", ".ll")));
                LLVM_Visitor vis4 = new LLVM_Visitor(table,llvm_writer);
                root.accept(vis4,null);
